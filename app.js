...
renderDots();renderTimeline();renderCollections();setupRevealAnimations();addEventListener("scroll",update,{passive:true});addEventListener("resize",update);addEventListener("load",update);update();
